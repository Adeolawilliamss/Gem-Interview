  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        "https://gem-interview.onrender.com/api/users/login",
        formData
      );
  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row">
        ...
        >
          <h2 className="text-2xl font-bold md:mt-20 mb-6 text-center">
            Login
          </h2>
          ...
          <button
            ...
            className="w-full bg-red-600 text-white py-2 mb-10 rounded hover:bg-red-700 transition"
          >
            Signup
          </button>
        </form>
